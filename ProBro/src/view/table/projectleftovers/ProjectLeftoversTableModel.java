package view.table.projectleftovers;
 ...
 * 
 */
public class ProjectLeftoversTableModel extends TableModel {
	...
	public ProjectLeftoversTableModel() {}
	...
	public Object getValueAt(int row, int column) {
		try {
			...
			ProjectDirEntry file = dirEntry.getProjectLeftoversList().get(row);
			...
			case 2:
				return new ProjectLeftoversSizeBar(file, dirEntry); 
			case 3:
	...
	public Class<?> getColumnClass(int column) {
		...
		case 1:
			return String.class;
		case 2:
			return ProjectLeftoversSizeBar.class;
		case 3:
	...
	/**
	 * Set the cell renderers specific to project leftovers view
	 * 
	 */
	@Override
	...
	public int getRowCount() {
		try {
			...
			return dirEntry.getProjectLeftoversList().size();
	...
	public ProjectDirEntry getRowDirEntry(int row) {
		try {
			...
			return dirEntry.getProjectLeftoversList().get(row);
	...
	public String getColumnName(int column) {
		try {
			return Messages.getString("ProjectLeftoversTable_ColumnHeader_" + column);
